...
export const Accordion = ({ title, content, openIcon, closeIcon, spacing }: accordionInterface) => {
  ...
  return (
    <AccordionContainer className="accordion-container" style={spacing ? { marginBottom: spacing} : {} }>
      <Accordionn className='accordion'>
        ...
        <AccordionCollapsible className={`accordion-collapsible ${open ? 'accordion-active' : 'accordion-inactive'}`}>
            {/* Content */}
            {content}
